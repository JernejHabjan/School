...
&nbsp;<asp:Button ID="divide" runat="server" Text="/" OnClick="divide_Click" />
        ...
        <br />
        <br />
        Zgodovina operacij:<br />
        <asp:ListBox ID="resultsHistory" runat="server" Height="112px" Width="196px"></asp:ListBox>
        <br />
        <br />
        <asp:Button ID="historyLength" runat="server" OnClick="historyLength_Click" Text="Število elementov v zgodovini:" />
