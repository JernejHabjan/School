...
namespace WcfService1.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/vrniIme", ReplyAction="http://tempuri.org/IService1/vrniImeResponse")]
        string vrniIme(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/vrniIme", ReplyAction="http://tempuri.org/IService1/vrniImeResponse")]
        System.Threading.Tasks.Task<string> vrniImeAsync(int id);
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WcfService1.ServiceReference1.IService1>, WcfService1.ServiceReference1.IService1 {
        ...
        public string vrniIme(int id) {
            return base.Channel.vrniIme(id);
        }
        
        public System.Threading.Tasks.Task<string> vrniImeAsync(int id) {
            return base.Channel.vrniImeAsync(id);
        }
