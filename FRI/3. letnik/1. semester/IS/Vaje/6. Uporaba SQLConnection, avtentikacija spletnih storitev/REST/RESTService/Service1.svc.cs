...
namespace RESTService
{
    ...
    {
        string cs = ConfigurationManager.ConnectionStrings["SQLConnectionDBConnectionString"].ConnectionString;
        ...
        public Oseba VrniOsebo()
        {
            ...
            using (SqlConnection connection = new SqlConnection())
            {
                ...
                SqlCommand command = new SqlCommand("Select * from Oseba where PersonID=1", connection);
