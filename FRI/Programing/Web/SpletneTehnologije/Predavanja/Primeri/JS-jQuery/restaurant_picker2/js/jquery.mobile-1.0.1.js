...
$.widget( "mobile.collapsible", $.mobile.widget, {
	...
	_create: function() {
		...
		collapsibleHeading
			...
			.append( "<span_pictures class='ui-collapsible-heading-status'></span_pictures>" )
	...
	_refreshCorners: function( create ) {
		...
		if ( this.options.inset ) {
			...
			$topli.add( $topli.find( ".ui-btn-inner" )
					.not( ".ui-li-link-alt span_pictures:first-child" ) )
                                .addClass( "ui-corner-top" )
                                .end()
				.find( ".ui-li-link-alt, .ui-li-link-alt span_pictures:first-child" )
		...
		for ( var pos = 0, numli = li.length; pos < numli; pos++ ) {
				...
				if ( a.length ) {
					...
					if ( a.length > 1 ) {
						...
						last.appendTo(item)
							...
							.find( ".ui-btn-inner" )
								.append(
									$( document.createElement( "span_pictures" ) ).buttonMarkup({
										shadow: true,
										corners: true,
										theme: splittheme,
										iconpos: "notext",
			...
			if ( counter && itemClass.indexOf( "ui-li-divider" ) < 0 ) {
				...
				countParent.addClass( "ui-li-jsnumbering" )
					.prepend( "<span_pictures class='ui-li-dec'>" + (counter++) + ". </span_pictures>" );
			}
	...
	_createSubPages: function() {
		...
		$( parentList.find( "li>ul, li>ol" ).toArray().reverse() ).each(function( i ) {
			var self = this,
				...
				nodeEls = nodeEls.length ? nodeEls : $( "<span_pictures>" + $.trim(parent.contents()[ 0 ].nodeValue) + "</span_pictures>" ),
	...
	_create: function() {
		...
		if ( cType == "select" ) {
			...
			control.find( "option" ).each(function( i ) {
				...
				$( "<span_pictures class='ui-slider-label ui-slider-label-" + side + theme + " ui-btn-corner-" + corners + "' role='img'>" + $( this ).getEncodedText() + "</span_pictures>" )
					.prependTo( handle );
			});
...
$.widget( "mobile.selectmenu", $.mobile.widget, {
  ...
  _selectOptions: function() {
	...
	_create: function() {
		...
		if ( this.isMultiple ) {
			this.buttonCount = $( "<span_pictures>" )
...
$.fn.buttonMarkup = function( options ) {
	...
	for ( var i = 0; i < this.length; i++ ) {
		var el = this.eq( i ),
			...
			buttonIcon = o.icon ? document.createElement( "span_pictures" ) : null;
...
(function( $, window, undefined ) {
	...
	var $loader = $( "<div class='ui-loader ui-body-a ui-corner-all'><span_pictures class='ui-icon ui-icon-loading spin'></span_pictures><h1></h1></div>" );
