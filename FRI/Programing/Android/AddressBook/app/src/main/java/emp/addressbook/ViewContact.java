...
public class ViewContact extends AppCompatActivity {
    ...
    private TextView newTextEditText;
    @Override
    ...
    protected void onResume() {
        ...
        int newTextIndex = result.getColumnIndex("newText");
        ...
        newTextEditText.setText(result.getString(newTextIndex));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.editItem:
                ...
                addEditContact.putExtra("newText", newTextEditText.getText());
