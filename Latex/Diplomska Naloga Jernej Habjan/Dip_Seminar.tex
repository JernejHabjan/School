...
Rezultat tega je gradnja hiš in urjenja figur v spodnji levi kot šahovnice, saj so izbrana prva polja v zaporedju, kot na primer x-1, y+1, in širjenje proti zgornjim desnim kotom, ko so vsa ostala polja zasedena, oziroma tam ni sovražnih figur.
...
\begin{table}
	\begin{center}
		\begin{tabular}{p{0.2\linewidth}|p{0.2\linewidth}|p{0.6\linewidth}}
			...
			{\tt ime igralca}        & 2                       & TODO bita zaradi treh različnih možnosti: 00 predstavlja prazno polje, 01 predstavlja igralca 1 in 10 igralca -1 \\
...
V poglavju bomo opisali ideje o učenju modela s postopnim učenjem, predstavili zgradbo nevronske mreže in predstavitev parametrov ITD ITDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD - nared tak intro
...
TODOOOOOOO - opiš še mav coach maybe - al to paše v "Alpha Zero"
...
Izboljšali smo pogoj izbiranja modelov, ki upošteva tudi ndraws - TODOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO - a nisi to že nekje opisu - ok NISI najs... sam opiš
\begin{verbatim}
if pwins + nwins == 0 
    or float(nwins) / (pwins + nwins + draws) < updateThreshold:
    # reject new model
else:
    # accept new model
\end{verbatim}
...
%TODO wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
...
% TODO Opiš zka se te parametri uprablajo
